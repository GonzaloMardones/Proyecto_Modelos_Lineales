...
Para decidir la entrada del segundo predictor se debe evaluar todos los modelos que contienen cuya variable respuesta es PROMEDIO_DIAS_LM agregando cada uno de los predictores por separado, para lo cual es necesario desarrollar un test F por predictor
...
###  Primera Variable que ingresa al modelo

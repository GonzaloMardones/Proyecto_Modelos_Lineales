...
p2<-ggplot(BBDD_proyecto_sin_ceros, aes(y = PROMEDIO_DIAS_LM)) +
  ...
  labs(
    title = "Box-plot del promedio de días por lic. Médicas",
    # subtitle = "Cantidad de DOCENTES: 500",
...
tabla_1 <- BBDD_proyecto_sin_ceros %>% 
  ...
  summarise(promedio = mean(PROMEDIO_DIAS_LM),
            ...
            Min = min(PROMEDIO_DIAS_LM),
            Max = max(PROMEDIO_DIAS_LM),
...
tabla_endogena_1 <- BBDD_proyecto_sin_ceros %>% 
  ...
  summarise(promedio = mean(PROMEDIO_DIAS_LM),
            ...
            Min = min(PROMEDIO_DIAS_LM),
            Max = max(PROMEDIO_DIAS_LM),
            Cantidad_LM_presentadas = sum(CANTIDAD_LM))

knitr::kable(tabla_endogena_1, align = c("l","c","c","c","c","c","c"))
...
knitr::kable(tabla_endogena_2, align = c("l","c","c","c","c","c","c"))
...
knitr::kable(tabla_endogena_3, align = c("l","c","c","c","c","c","c"))
...
knitr::kable(tabla_exogena_1, align = c("l","c","c","c","c","c","c","c"))
knitr::kable(tabla_exogena_2, align = c("l","c","c","c","c","c","c","c"))
knitr::kable(tabla_exogena_3, align = c("l","c","c","c","c","c","c","c"))
knitr::kable(tabla_exogena_4, align = c("l","c","c","c","c","c","c","c"))
knitr::kable(tabla_exogena_5, align = c("l","c","c","c","c","c","c","c"))
knitr::kable(tabla_exogena_6, align = c("l","c","c","c","c","c","c","c"))
knitr::kable(tabla_exogena_7, align = c("l","c","c","c","c","c","c","c"))

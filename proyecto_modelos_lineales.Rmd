...
## Estadística Descriptiva Oscar


```{r, message=FALSE, warning=FALSE}
 

#kable(summary(BBDD_proyecto_sin_ceros))

# Variable Sexo
ggplot(data=BBDD_proyecto_sin_ceros, aes(x=SEXO))+
  geom_bar()+
...
p1<-ggplot(data=df_final_femenino, aes(x=EDAD))+
     ...
     geom_density(alpha = 0.6 , fill = "#FF6666", lwd = 1,colour = 2)+
     labs(
       title="Distribución de la variable Edad (Género Femenino)",
       y="Frecuencia",
       x="Edad"
     )+
     theme_minimal()
...
p2<-ggplot(data=df_final_masculino, aes(x=EDAD))+
     ...
     geom_density(alpha = 0.6 , fill = "#FF6666", lwd = 1,colour = 2)+
     labs(
       title="Distribución de la variable Edad (Género Masculino)",
       y="Frecuencia",
       x="Edad"
     )+
     theme_minimal()
...
p3<-ggplot(data=BBDD_proyecto_sin_ceros, aes(x=SEXO, y=EDAD))+
     geom_boxplot() +
     labs(
       title="Distribución de la variable Edad (por Sexo)",
       y="Edad",
       x="Sexo"
     )+
     theme_minimal()
...
p1<-ggplot(data=BBDD_proyecto_sin_ceros, aes(x=RENTA_PROMEDIO))+
     ...
     geom_density(alpha = 0.6 , fill = "#FF6666", lwd = 1,colour = 2)+
     labs(
       title="Distribución de la variable Renta Promedio",
       y="Frecuencia",
       x="Renta Promedio"
     )+
     theme_minimal()
...
# Renta Promedio sexo femenino
BBDD_proyecto_sin_ceros %>% 
  ggplot(aes(x = SEXO, y = RENTA_PROMEDIO)) +
  geom_boxplot() +
